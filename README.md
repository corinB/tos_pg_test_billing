...
2.  **카드 등록**: 토스페이먼츠 SDK를 활용한 보안 카드 등록 창 연동
...
*   **Database**: MySQL
*   **Frontend**: Thymeleaf, Toss Payments JavaScript SDK
*   **Tool**: Gradle, Lombok
...
1.  **[구현 명세서 (Implementation Spec)](./TOSS_BILLING_IMPLEMENTATION.md)**: DB 설계, API 명세, 아키텍처 및 로직 상세 설명
